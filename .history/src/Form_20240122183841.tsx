          ...
          <div className="flex z-10 justify-center w-screen right-[50%] left-[50%] items-center h-[100vh] absolute">
            ...
            >
              <div className="flex justify-center items-center w-full pr-4">
                <p className="font-bold text-2xl text-smokewhite">Input Country Details</p>
              </div>
              <div className="flex space-x-2">
                <p className="font-semibold">Enter Country Name</p>
                <input
                  type="text"
                  ...
                  <>
                    <div className="flex justify-center items-center w-full pt-4 z-10">
                      <button
                        ...
                        className={`${
                          name.trim() !== ""
                            ? "border-2 border-white rounded-md px-2 duration-300 ease-in-out transition-transform hover:scale-110"
