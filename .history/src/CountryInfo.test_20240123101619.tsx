...
describe('CountryInfo', () => {
    ...
    it("should handle null Data", () => {
         render(
          <MemoryRouter initialEntries={[{ pathname: "/1234567", state: null }]}>
            <CountryInfo />
          </MemoryRouter>
        );
    ...
    it('should go back when the Go Back button is clicked', async () => {
        const wrapper = render(
          <MemoryRouter
            initialEntries={[{ pathname: "/countrydetails", state: null }]}
          >
            <CountryInfo />
          </MemoryRouter>
        );
        ...
        const backButton = wrapper.findByText("#backbutton");
