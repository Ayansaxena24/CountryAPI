...
describe("CountryInfo", () => {
  it("renders without crashing", () => {
    const wrapper = shallow(<BrowserRouter><CountryInfo countryDetails={[mockData]} /></BrowserRouter>);
    expect(wrapper.exists()).toBe(true);
  });

  it("renders the table", () => {
    const wrapper = render(<BrowserRouter><CountryInfo countryDetails={[mockData]} /></BrowserRouter>);
