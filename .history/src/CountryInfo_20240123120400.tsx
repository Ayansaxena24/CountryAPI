...
const CountryInfo = () => {
  ...
  console.log("countryDetails ===> ", location);

  const countryData : CountryDetails = countryDetails ? countryDetails[0] ;
              ...
              {!weatherInfo ? (
                <TableRow>
                  <TableCell colSpan={2} align="center" className="space-x-4">
                    <Button id="capital" variant="outlined" sx={{borderColor : "white", color : "white"}} onClick={handleWeatherData}>
                      CAPITAL WEATHER
                    </Button>
                  </TableCell>
                </TableRow>
