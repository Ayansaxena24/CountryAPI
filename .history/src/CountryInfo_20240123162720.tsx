...
class CountryInfo extends Component<CountryInfoProps, CountryInfoState> {
  constructor(props: CountryInfoProps) {
    ...
    this.state = {
      weatherInfo: {"coord":{"lon":77,"lat":20},"weather":[{"id":803,"main":"Clouds","description":"broken clouds","icon":"04d"}],"base":"stations","main":{"temp":300.63,"feels_like":299.57,"temp_min":300.63,"temp_max":300.63,"pressure":1011,"humidity":21,"sea_level":1011,"grnd_level":957},"visibility":10000,"wind":{"speed":3.72,"deg":327,"gust":3.91},"clouds":{"all":60},"dt":1706007255,"sys":{"country":"IN","sunrise":1705973369,"sunset":1706013444},"timezone":19800,"id":1269750,"name":"India","cod":200},
      countryData: null,
    };
  }
