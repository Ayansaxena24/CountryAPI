  ...
  it('should handle fetchWeatherData', async () => {
    ...
    global.fetch = jest.fn().mockResolvedValue({
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `https://api.openweathermap.org/data/2.5/weather?lat=${mockWeatherData.state.coord.lat}&lon=${mockWeatherData.coord.lon}&appid=ba21f1fb2256fc495bceed24839bca72`
      );
