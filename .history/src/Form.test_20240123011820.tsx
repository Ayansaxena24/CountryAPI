...
describe('FormInput', () => {
  ...
  it('renders "Enter Country Name" text correctly', () => {
    ...
    it('renders input field correctly', () => {
        render(<MemoryRouter><FormInput /></MemoryRouter>);
        const inputField = screen.getBy('input-field');
        expect(inputField).toBeInTheDocument();
        expect(inputField).toHaveClass('bg-black pl-2 bg-opacity-60 backdrop-blur-lg border-2 rounded-md');
    });

//   it('handles form submission correctly', async () => {
//     render(<MemoryRouter><FormInput /></MemoryRouter>);

//     const inputField = await screen.findByText("input") as HTMLInputElement;
